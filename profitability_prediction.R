...
# input: "existing_Age_Professional_Competitors.csv",
#       "newproduct_Age_Professional_Competitors.csv"
...
# detect rows for which all reviews are 0
...
cleanData <-
  subset(dumData, select = c(x5, x3, posit, negat, volume))

# create data partition ####
set.seed(123)
inTrain <- createDataPartition(y = cleanData$volume,
                               p = .75,
                               list = FALSE)
